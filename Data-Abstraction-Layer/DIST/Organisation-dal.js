...
class OrganisationDal {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            let connection;
            try {
                connection = yield this.mysqlConnection.getConnection();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (userResult != null) {
                    ...
                    const orgaresult = yield this.mysqlConnection.executeQuery('INSERT INTO organisation (type_organisation, id_utilisateur) VALUES (?, ?)', [data.type_organisation, userResult.insertId]);
                    return orgaresult;
                }
                else {
    ...
    get(entityName, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.connect();
                const userResult = yield this.mysqlConnection.executeQuery(`select * from utilisateur,organisation 
            ,utilisateur_images 
            where utilisateur.id_utilisateur=organisation.id_utilisateur
            AND organisation.id_utilisateur=${id}`, [id]);
    ...
    findAll(entityName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.connect();
                const userResult = yield this.mysqlConnection.executeQuery(`select * from organisation,utilisateur
            where organisation.id_utilisateur=utilisateur.id_utilisateur`, null);
                return userResult;
            }
            catch (error) {
                console.error('Error getting entity:', error);
    ...
    findByFilter(entityName, filter) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log("datada" + userResult + "datadtah");
                if (userResult != '') {
                    console.log("your json" + JSON.stringify(userResult[0].id_utilisateur));
                    const organisationresult = yield this.mysqlConnection.executeQuery('SELECT * FROM  organisation where id_utilisateur = ? ', [userResult[0].id_utilisateur]);
...
exports.default = OrganisationDal;
